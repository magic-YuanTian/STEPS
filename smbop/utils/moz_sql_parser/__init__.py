...
from backend.structuredSmBop.smbop.utils.moz_sql_parser.sql_parser import SQLParser, all_exceptions
...
def parse(sql):
    ...
    try:
        parse_result = SQLParser.parseString(sql, parseAll=True) # I have modified the core code (just neglect the exception)
