...
try:
    from backend.structuredSmBop.smbop.eval_final.process_sql import (
        tokenize,
        get_schema,
    ...
    from backend.structuredSmBop.smbop.eval_final.process_sql import tokenize, get_schema, get_tables_with_alias, Schema, get_sql
...
def evaluate_single(g_str, p_str, db_id, db_dir, table_file):
    ...
    return evaluator.eval_exact_match(p_sql, g_sql)
