...
2. Generate text to clause dataset using SQL2NL/SQL2NL.py
  ...
  - You could also download [our raw text-to-clause dataset](). Please put it in the same directory of the original Spider dataset and inlcude all the databases (For more information, please refer to https://github.com/taoyds/spider)
